  ...
  <body>
    ...
    <form method="POST" action="{{route('comunas.update', ['comuna' => $coumna->comu_codi])}}">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="id" aria-describedby="codigoHelp" name="id" disabled="disable" value="{{$coumna->comu_codi}}">
          <div id="idHelp" class="form-text">Commune Id.</div>
        </div>
        <div class="mb-3">
          <label for="name" class="form-label">Comumune</label>
